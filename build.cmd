...
SET ARGS=-SaveWidth=1024 -SaveHeight=1024 -ShowErrors=0 -SaveActualSize=0 -v
SET PACKAGE_PATH=Build\%CONFIGURATION%%PL%\%PACKAGE%%PL%.exe
SET COMMAND_LINE_ARGS= "%IN_FILE%" -HaveStdOut=1 -LDrawDir="%LDRAW_DIR%" -SaveSnapshot="%OUT_FILE%" -IniFile="%INI_FILE%" %ARGS% -LDConfig="%ALT_LDCONFIG_FILE%"
