...
void LDViewPreferences::doStudStyle(void)
{
	...
	{
		hHighContrastColorButton = GetDlgItem(hPrimitivesPage, IDC_HIGH_CONTRAST_COLOR);
		EnableWindow(hHighContrastColorButton, FALSE);
	}
...
void LDViewPreferences::setupStudStyle(void)
{
	...
	CUIDialog::comboAddString(hPrimitivesPage, IDC_STUD_STYLE_COMBO, ls(_UC("SharpLogo")));
	CUIDialog::comboAddString(hPrimitivesPage, IDC_STUD_STYLE_COMBO, ls(_UC("RoundedLogo")));
	CUIDialog::comboAddString(hPrimitivesPage, IDC_STUD_STYLE_COMBO, ls(_UC("FlattenedLogo")));
	CUIDialog::comboAddString(hPrimitivesPage, IDC_STUD_STYLE_COMBO, ls(_UC("HighContrastPlain")));
	CUIDialog::comboAddString(hPrimitivesPage, IDC_STUD_STYLE_COMBO, ls(_UC("HighContrastThinLine")));
