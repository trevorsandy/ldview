...
echo "Checking for existing LDRAWDIR in environment.plist"
grep -q -e 'LDRAWDIR' ~/.MacOSX/environment.plist

if [ $? == 0 ]; 
then
echo "LDRAWDIR is set"

else
echo "Adding LDRAWDIR to environment.plist"
