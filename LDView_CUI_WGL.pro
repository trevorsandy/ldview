...
3RD_PARTY_INSTALL {
    message("~~~ WGL CUI 3RD PARTY INSTALL PREFIX $${3RD_PREFIX} ~~~")
    ...
    COPY_HEADERS_CMD = $${COPY_CMD} $$shell_path($$absolute_path(TCFoundation/*.h)) $$shell_path($${3RD_HEADERS}/TCFoundation/) \
        ...
        $$escape_expand(\n\t)$${COPY_CMD} $$shell_path($$absolute_path(CUI/*.h)) $$shell_path($${3RD_HEADERS}/CUI/) \
    ...
    documentation.files      = Readme.txt Help.html license.txt \
                               ChangeHistory.html OSMesa/ldview.1
    resources.path           = $${3RD_RESOURCES}
    resources.files          = m6459.ldr 8464.mpd OSMesa/ldviewrc.sample \
...
LIBS_  += -lversion -lcomctl32 -lcomdlg32 -lshell32 -lole32 -lhtmlhelp -lwinhttp
...
LDV_MESSAGES_HEADER     = $$shell_path($$absolute_path($$_PRO_FILE_PWD_/LDViewCUIMessages.h))
LDV_CONCAT_MESSAGES     = $$shell_path($$absolute_path($$_PRO_FILE_PWD_/LDViewCUIMessages.ini))
...
!equals(PWD, $${OUT_PWD}) {
    ...
    LDV_MOVE_CMD = ; mv -f
    LDV_HEADERIZE_MESSAGES_CMD = $$LDV_HEADERIZE $$LDV_CONCAT_MESSAGES $$LDV_MOVE_CMD LDViewCUIMessages.h $$LDV_MESSAGES_HEADER 2> $$NULL_DEVICE
...
QMAKE_EXTRA_TARGETS        += headerize_studlogo headerize_messages
...
# input
HEADERS += \
    $$PWD/LDViewCUIModelLoader.h \
    $$PWD/LDViewCUIWindow.h \
    $$PWD/LDViewPreferences.h \
    $$PWD/LDVExtensionsSetup.h \
    $$PWD/ModelWindow.h \
    $$PWD/WinWebClientPlugin.h
unix|msys: \
HEADERS += \
    $$PWD/OSMesa/GLInfo.h
...
SOURCES += \
    $$PWD/LDViewCUI.cpp \
    $$PWD/LDViewCUIModelLoader.cpp \
    $$PWD/LDViewCUIWindow.cpp \
    $$PWD/LDViewPreferences.cpp \
    $$PWD/LDVExtensionsSetup.cpp \
    $$PWD/ModelWindow.cpp \
    $$PWD/WinWebClientPlugin.cpp
unix|msys: \
SOURCES += \
